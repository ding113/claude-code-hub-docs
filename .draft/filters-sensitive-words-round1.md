# Sensitive Words Detection - Round 1 Exploration Draft
...
5. If blocked: Return error response immediately
   If passed: Continue to next guard (rate limiting, etc.)
```
...
**File**: `/Users/ding/Github/claude-code-hub/src/lib/message-extractor.ts` (lines 149-172)
...
**File**: `/Users/ding/Github/claude-code-hub/src/app/v1/_lib/proxy/sensitive-word-guard.ts` (lines 121-147)
...
**File**: `/Users/ding/Github/claude-code-hub/src/drizzle/schema.ts` (lines 538-552)
...
**Migration File**: `/Users/ding/Github/claude-code-hub/drizzle/0003_outstanding_centennial.sql`
...
**File**: `/Users/ding/Github/claude-code-hub/src/repository/sensitive-words.ts`
...
**File**: `/Users/ding/Github/claude-code-hub/src/actions/sensitive-words.ts`
...
**Main Page**: `/Users/ding/Github/claude-code-hub/src/app/[locale]/settings/sensitive-words/page.tsx`
...
**Add Word Dialog**: `/Users/ding/Github/claude-code-hub/src/app/[locale]/settings/sensitive-words/_components/add-word-dialog.tsx`
...
**Word List Table**: `/Users/ding/Github/claude-code-hub/src/app/[locale]/settings/sensitive-words/_components/word-list-table.tsx`
...
**File**: `/Users/ding/Github/claude-code-hub/src/lib/sensitive-word-detector.ts` (lines 36-93)
...
| File | Purpose | Lines |
|------|---------|-------|
| `/Users/ding/Github/claude-code-hub/src/lib/sensitive-word-detector.ts` | Core detection engine with caching | 190 |
| `/Users/ding/Github/claude-code-hub/src/app/v1/_lib/proxy/sensitive-word-guard.ts` | Proxy guard integrating detection | 149 |
| `/Users/ding/Github/claude-code-hub/src/lib/message-extractor.ts` | Text extraction from messages | 173 |
| `/Users/ding/Github/claude-code-hub/src/repository/sensitive-words.ts` | Database repository for CRUD | 128 |
| `/Users/ding/Github/claude-code-hub/src/actions/sensitive-words.ts` | Server actions for admin UI | 262 |
| `/Users/ding/Github/claude-code-hub/src/drizzle/schema.ts` | Database schema definition | Lines 538-552 |
| `/Users/ding/Github/claude-code-hub/src/app/v1/_lib/proxy/guard-pipeline.ts` | Pipeline configuration | 204 |

### Admin UI Files

| File | Purpose |
|------|---------|
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/settings/sensitive-words/page.tsx` | Main admin page |
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/settings/sensitive-words/_components/add-word-dialog.tsx` | Add word dialog |
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/settings/sensitive-words/_components/edit-word-dialog.tsx` | Edit word dialog |
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/settings/sensitive-words/_components/word-list-table.tsx` | Words table |
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/settings/sensitive-words/_components/refresh-cache-button.tsx` | Cache refresh button |

### Database Files

| File | Purpose |
|------|---------|
| `/Users/ding/Github/claude-code-hub/drizzle/0003_outstanding_centennial.sql` | Migration creating sensitive_words table |

### i18n Files

| File | Language |
|------|----------|
| `/Users/ding/Github/claude-code-hub/messages/zh-CN/settings/sensitiveWords.json` | Chinese (Simplified) |
| `/Users/ding/Github/claude-code-hub/messages/zh-TW/settings/sensitiveWords.json` | Chinese (Traditional) |
| `/Users/ding/Github/claude-code-hub/messages/en/settings/sensitiveWords.json` | English |
| `/Users/ding/Github/claude-code-hub/messages/ja/settings/sensitiveWords.json` | Japanese |
| `/Users/ding/Github/claude-code-hub/messages/ru/settings/sensitiveWords.json` | Russian |

### Key Code Snippets

**Detection Logic** (lines 101-144 in sensitive-word-detector.ts):
...
export const CHAT_PIPELINE: GuardConfig = {
  steps: [
    "auth",
    "sensitive",  // Sensitive word check happens 2nd
    "client",
    "model",
    "version",
    "probe",
...
**Database Schema** (lines 538-552 in schema.ts):
...
3. Early detection in pipeline (after auth, before rate limiting)
