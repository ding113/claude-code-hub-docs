# Round 1 Exploration Draft: 权限控制系统 (Permission Control System)

**Route**: `/docs/users/permissions`  
**Status**: Technical Exploration Draft  
...
```typescript
// From /Users/ding/Github/claude-code-hub/src/app/api/leaderboard/route.ts
...
```typescript
// From /Users/ding/Github/claude-code-hub/src/proxy.ts
...
export const users = pgTable('users', {
  ...
  // ... additional quota and restriction fields
}, (table) => ({
...
export interface User {
  ...
  updatedAt: Date;
  deletedAt?: Date;
  // ... additional fields for quotas and restrictions
}
```
...
#### 3.4.2 Route Configuration Example

From `/Users/ding/Github/claude-code-hub/src/app/api/actions/[...route]/route.ts`:
...
const { route: removeUserRoute, handler: removeUserHandler } = createActionRoute(
  ...
  userActions.removeUser,
  {
    ...
    summary: "删除用户",
    tags: ["用户管理"],
    requiredRole: "admin",  // Explicit role requirement
  }
);
```
...
Both have identical permissions, but the admin token user cannot be modified through the UI.
...
From `/Users/ding/Github/claude-code-hub/messages/zh/errors.json`:
...
| File | Purpose |
|------|---------|
| `/Users/ding/Github/claude-code-hub/src/lib/permissions/user-field-permissions.ts` | Field-level permission configuration and checking functions |
| `/Users/ding/Github/claude-code-hub/src/lib/auth.ts` | Session management, authentication, and role retrieval |
| `/Users/ding/Github/claude-code-hub/src/drizzle/schema.ts` | Database schema including user role field |
| `/Users/ding/Github/claude-code-hub/src/types/user.ts` | TypeScript type definitions for User with role |

### 8.2 Permission Enforcement Locations

| File | Pattern Used |
|------|--------------|
| `/Users/ding/Github/claude-code-hub/src/actions/users.ts` | Role checks, field filtering, ownership verification |
| `/Users/ding/Github/claude-code-hub/src/actions/keys.ts` | Role checks, ownership verification |
| `/Users/ding/Github/claude-code-hub/src/actions/sensitive-words.ts` | Admin-only checks |
| `/Users/ding/Github/claude-code-hub/src/actions/error-rules.ts` | Admin-only checks |
| `/Users/ding/Github/claude-code-hub/src/actions/providers.ts` | Admin-only checks |
| `/Users/ding/Github/claude-code-hub/src/actions/active-sessions.ts` | Role-based filtering |
| `/Users/ding/Github/claude-code-hub/src/app/api/leaderboard/route.ts` | Role + settings check |

### 8.3 Frontend Permission Checks

| File | Pattern Used |
|------|--------------|
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/dashboard/providers/page.tsx` | Route-level redirect |
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/dashboard/sessions/page.tsx` | Route-level redirect |
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/dashboard/_components/user/user-actions.tsx` | Component-level conditional render |
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/dashboard/_components/user/key-actions.tsx` | Component-level conditional render |
| `/Users/ding/Github/claude-code-hub/src/app/[locale]/dashboard/leaderboard/page.tsx` | Permission-based UI display |
...
```typescript
// From /Users/ding/Github/claude-code-hub/src/actions/users.ts (line 1225)
if (!session || session.user.role !== "admin") {
  return {
    ok: false,
    error: tError("PERMISSION_DENIED"),
...
```typescript
// From /Users/ding/Github/claude-code-hub/src/actions/keys.ts (line 120)
...
```typescript
// From /Users/ding/Github/claude-code-hub/src/actions/users.ts (line 1158-1163)
...
#### 8.4.4 Frontend Role-Based Rendering

```typescript
// From /Users/ding/Github/claude-code-hub/src/app/[locale]/dashboard/_components/user/user-actions.tsx (line 22)
...
*End of Round 1 Exploration Draft*
