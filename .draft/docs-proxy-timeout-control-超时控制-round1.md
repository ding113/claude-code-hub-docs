...
Provider timeout fields in `/Users/ding/Github/claude-code-hub/src/types/provider.ts`:
...
const API_TEST_CONFIG = {
  TIMEOUT_MS: resolveApiTestTimeoutMs(),  // From env or default
...
setGlobalDispatcher(
  new Agent({
    ...
    headersTimeout,      // Response headers timeout
    bodyTimeout,         // Body transfer timeout
  })
);
```
...
6. **Provider Types**: `/Users/ding/Github/claude-code-hub/src/types/provider.ts`
7. **Validation Schemas**: `/Users/ding/Github/claude-code-hub/src/lib/validation/schemas.ts`
8. **API Test Actions**: `/Users/ding/Github/claude-code-hub/src/actions/providers.ts`
9. **Environment Example**: `/Users/ding/Github/claude-code-hub/.env.example`
10. **Error Messages**: `/Users/ding/Github/claude-code-hub/messages/en/errors.json`
...
- Timezone resolver tests: `/Users/ding/Github/claude-code-hub/tests/unit/lib/timezone/timezone-resolver.test.ts`
